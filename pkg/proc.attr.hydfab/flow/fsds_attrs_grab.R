...
raw_config <- yaml::read_yaml("/Users/guylitt/git/fsds/scripts/workflow_configs/legacy/xssa/xssa_attr_config.yaml") # Example that performs both fsds_proc and single locations dataset option
# raw_config <- yaml::read_yaml("/Users/guylitt/git/fsds/scripts/workflow_configs/legacy/xssa/loc_file_attr_config.yaml") # Example for only reading in locations from a single dataset
