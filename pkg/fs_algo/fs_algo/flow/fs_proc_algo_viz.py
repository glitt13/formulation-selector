...
if __name__ == "__main__":
    ...
    path_algo_config = Path(args.path_algo_config).expanduser() #Path(f'~/git/formulation-selector/scripts/eval_ingest/xssa/xssa_algo_config.yaml') 
    ...
    for ds in datasets: 
        ...
        try:
            df_attr = fsate.fs_read_attr_comid(dir_db_attrs, locids_resp, attrs_sel = attrs_sel,
