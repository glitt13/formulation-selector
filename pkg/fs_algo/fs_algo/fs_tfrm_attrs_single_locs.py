...
`Path(f'{home_dir}/git/formulation-selector/scripts/workflow_configs/legacy/xssa/xssa_attrs_tform.yaml')`
...
if __name__ == "__main__":
    ...
    home_dir = Path.home()
    path_tfrm_cfig = Path(args.path_tfrm_cfig)#path_tfrm_cfig = Path(f'{home_dir}/git/formulation-selector/scripts/workflow_configs/legacy/xssa/xssa_attrs_tform.yaml') 
