...
Usage:
python fs_proc_viz_xssaus.py "~/git/formulation-selector/scripts/workflow_configs/legacy/xssa_us/xssaus_pred_config.yaml"
...
if __name__ == "__main__":
    ...
    for ds in datasets:
        ...
        path_fs_proc = fsutil._std_fs_proc_ds_paths(dir_std_base, ds =ds, mtch_str='*.nc')
        path_gpkg = fsutil._std_fs_proc_ds_companion_gpkg_path(path_fs_proc[0])
