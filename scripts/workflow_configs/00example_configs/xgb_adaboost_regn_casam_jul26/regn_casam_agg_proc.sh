...
DIR_CONFIG="${DIR_REPO}/scripts/workflow_configs/regn_jul26_test2"
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_proc_algo_pool.py" "${DIR_CONFIG}/regn_casam_algo_config_uncn.yaml" --chunk_size 4 || {
...
# uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_pred_algo.py" "${DIR_CONFIG}/regn_casam_pred_config_uncn.yaml" || {
...
# uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_map_pred_hfatl.py" "${DIR_CONFIG}/regn_casam_pred_config_uncn.yaml" || {
...
# # 6. Write Parameters to Compiled GeoPackage
# echo "--> Compiling regionalized parameters into master GPKG..."
# uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_regn_params_gpkg.py" "${DIR_CONFIG}/regn_casam_pred_config_uncn.yaml" || {
