...
DIR_CONFIG="${DIR_REPO}/scripts/eval_ingest/regn_hf4vpu1_clst_jul26_test2"
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_proc_algo_pool.py" "${DIR_CONFIG}/regn_casam_algo_config.yaml" --chunk_size 4 || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_pred_algo.py" "${DIR_CONFIG}/regn_casam_pred_config_hf4.yaml" || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_pair_donors.py" "${DIR_CONFIG}/regn_casam_pred_config_hf4.yaml" || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_map_pred_hfatl.py" "${DIR_CONFIG}/regn_casam_pred_config_hf4.yaml" || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_regn_params_gpkg.py" "${DIR_CONFIG}/regn_casam_pred_config_hf4.yaml" || {
