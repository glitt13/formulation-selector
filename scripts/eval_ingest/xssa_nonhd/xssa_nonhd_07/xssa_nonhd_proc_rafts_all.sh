...
DIR_CONFIG="${DIR_REPO}scripts/eval_ingest/xssa_nonhd/xssa_nonhd_07/"
...
Rscript "${DIR_R}fs_attrs_grab.R" "${DIR_CONFIG}xssa_nonhd_attr_config.yaml"
echo "Attribute grabbing completed!"

# 2.5 Run attribute transformer
echo "Generating transformed attributes"
python3 "${DIR_PY}fs_tfrm_attrs.py" "${DIR_CONFIG}xssa_nonhd_attrs_tform.yaml"
echo "Attribute transformations completed!"

# 3. Train the algorithms
echo "Training & testing algorithms..."
python3 "${DIR_PY}fs_proc_algo_viz.py" "${DIR_CONFIG}xssa_nonhd_algo_config.yaml"
...
python3 "${DIR_PY}fs_pred_algo.py" "${DIR_CONFIG}xssa_nonhd_pred_config.yaml"
