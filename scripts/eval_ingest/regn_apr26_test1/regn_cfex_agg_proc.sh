...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_proc_algo_pool.py" "${DIR_CONFIG}/regn_cfex_algo_config_uncn.yaml" --chunk_size 4 || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_pred_algo.py" "${DIR_CONFIG}/regn_cfex_pred_config_uncn.yaml" || {
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_PY}/fs_map_pred_hfatl.py" "${DIR_CONFIG}/regn_cfex_pred_config_uncn.yaml" || {
