...
uv run python "${DIR_CONFIG}/prep_regn_test_agg.py" "${DIR_CONFIG}/regn_agg_prep_config.yaml" || {
...
uv run python "${DIR_PREP}/fs_hfatlas_to_rafts_prep.py" \
    --path_prep_config "${DIR_CONFIG}/regn_agg_prep_config.yaml" \
    --name_attr_config "regn_attr_config.yaml" || {
...
uv run python "${DIR_PY}/fs_proc_algo_pool.py" "${DIR_CONFIG}/regn_algo_config_uncn.yaml" --chunk_size 4 || {
...
uv run python "${DIR_PY}/fs_pred_algo.py" "${DIR_CONFIG}/regn_pred_config_uncn.yaml" || {
...
uv run python "${DIR_PY}/fs_map_pred_hfatl.py" "${DIR_CONFIG}/regn_pred_config_uncn.yaml" || {
