...
if __name__ == "__main__":
    ...
    # Read the hydrofabric divides used for the april 2026 calibrations and pick one for a quick-and-dirty assessment
    # This assumes that the attributes from one divide within a basin is representative-enough. Future work will work with basin averages of attributes
    ...
    ds = pem.proc_col_schema(df_cmbo_id, col_schema_df, dir_save)
