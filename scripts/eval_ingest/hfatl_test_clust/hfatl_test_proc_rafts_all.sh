...
DIR_CONFIG="${DIR_REPO}/scripts/eval_ingest/hfatl_test_clust"
...
uv run --project "${DIR_REPO}/pkg" python "${DIR_CONFIG}/prep_hfatl_test.py" "${DIR_CONFIG}/hfatl_prep_config.yaml" || {
