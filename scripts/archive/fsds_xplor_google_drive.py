...
path_to_token = '/Users/guylitt/git/fsds/scripts/archive/token.json'
...
#gauth.LoadCredentialsFile("/Users/guylitt/git/fsds/scripts/archive/creds.json")#LoadClientConfig()#LoadClientConfigFile(path_to_token)#.LoadCredentialsFile(path_to_token)
