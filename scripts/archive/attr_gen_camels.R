...
#' of interest.
#' @usage Rscript attr_gen_camels.R "~/git/rafts/scripts/archive/attr_gen_camels_config.yaml"
#'
...
main <- function(){
  ...
  path_config <- glue::glue(cmd_args[1]) # path_config <- "~/git/rafts/scripts/archive/attr_gen_camels_config.yaml"
