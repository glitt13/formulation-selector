...
main <- function(){
  ...
  # Read in locations generated by Lauren:
  # TODO describe how these locations were identified
  ...
  if(TRUE){ # TODO Remove this after processing finishes for the new data
    df <- df_add
  }
