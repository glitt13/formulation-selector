...
main <- function(){
  ...
  path_cfig_pred <- glue::glue(as.character(args[1])) # path_cfig_pred <- glue::glue("{home_dir}/git/formulation-selector/scripts/workflow_configs/legacy/xssa/xssa_pred_config.yaml")
  ...
  path_raw_config <- glue::glue("{home_dir}/git/formulation-selector/scripts/workflow_configs/legacy/xssa/xssa_config.yaml")
