...
### TLDR
 ...
 - Build a yaml config file `/sripts/eval_metrics/name_of_dataset_here/name_of_dataset_schema.yaml` (refer to this template)[https://github.com/glitt13/fsds/blob/std_catg/scripts/workflow_configs/legacy/xssa/xssa_schema.yaml)
 - Create a script that reads in the data and runs the standardization processing. [Example script here](https://github.com/glitt13/fsds/blob/std_catg/scripts/workflow_configs/legacy/xssa/proc_xssa_metrics.py)
