...
```bash
uv run python pkg/fs_algo/fs_algo/flow/fs_pair_donors.py "scripts/workflow_configs/path_to/*hfatl*_pred_config.yaml"
...
(Only for unsupervised clustering algorithms)
```bash
uv run python pkg/fs_algo/fs_algo/flow/fs_write_params_gpkg.py "scripts/workflow_configs/path_to/*_pred_config.yaml"
```